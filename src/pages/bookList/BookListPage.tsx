  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "960px", margin: "0 auto" }}>
        {/* 面包屑 */}
        <div style={{ marginBottom: "20px", fontSize: "13px", color: "rgba(255,255,255,0.7)" }}>
          <Link to="/home" style={{ color: "rgba(255,255,255,0.6)", textDecoration: "none" }}>
            首页
          </Link>
      ...
      >
        {/* 搜索框容器（用于下拉定位） */}
        <div ref={wrapperRef} style={{ flex: "1 1 320px", position: "relative" }}>
          <div style={{ position: "relative", display: "flex", alignItems: "center" }}>
            ...
            <input
              ...
              onFocus={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 0 0 3px rgba(52,152,219,0.12)";
          ...
          {showHistory && history.length > 0 && (
            ...
            >
              ...
              >
                <span style={{ fontSize: "12px", color: "#8aa0b8", fontWeight: 500 }}>
                  搜索历史
                </span>
                <button
                  ...
                  onMouseLeave={(e) => (e.currentTarget.style.color = "#a0b8d0")}
                >
                  清空记录
                </button>
              </div>
              ...
              {history.map((term, idx) => (
                ...
                >
                  <span style={{ fontSize: "13px", color: "#c0d0e0" }}>🕐</span>
